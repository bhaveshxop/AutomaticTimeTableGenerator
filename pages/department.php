    ...
    <div class="container mt-3">
        ...
        <div class="content">
            <div class="d-flex mb-3 ">
                ...
                <input type="text" class="form-control me-2 mt-2" placeholder="Department name">
                <!-- Input department code -->
                <input type="text" class="form-control me-2 mt-2" placeholder="Department code">

                <button type="button" class="btn btn-success mt-2 w-25">Add Department</button>
